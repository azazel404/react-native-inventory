...
class DetailAssets extends React.Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      ...
      no_barang:
        this.props.nama_barang !== undefined ? this.props.nama_barang : '',
      no_surat: this.props.no_surat !== undefined ? this.props.no_surat : '',
      nama_barang:
        this.props.nama_barang !== undefined ? this.props.nama_barang : '',
      description:
        this.props.description !== undefined ? this.props.description : '',
      status: this.props.status !== undefined ? this.props.status : '',
      merk: this.props.merk !== undefined ? this.props.merk : '',
      model: this.props.model !== undefined ? this.props.model : '',
      serial: this.props.serial !== undefined ? this.props.serial : '',
      kategori: this.props.kategori !== undefined ? this.props.kategori : '',
      tahun_produksi:
        this.props.tahun_produksi !== undefined
          ? this.props.tahun_produksi
          : '',
      file: '',
      date:
        this.props.tahun_produksi !== undefined
  ...
  updateProduct(id) {
    ...
    // }
      ...
      return axios
        .put(`${API_URL}products/update-product/${id}`, formData, {
          headers: {
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              ...
              {this.state.tahun_produksi === null
                ? 'Tahun Produksi'
                : moment
                    .unix(Number(this.state.tahun_produksi))
                    .format('DD/MM/YYYY')}
            </Text>
          </TouchableOpacity>
          <View
          ...
          >
            <TouchableOpacity
              onPress={() => this.updateProduct(this.props._id)}
              style={{
                backgroundColor: color.Blue,
                justifyContent: 'center',
                width: '100%',
